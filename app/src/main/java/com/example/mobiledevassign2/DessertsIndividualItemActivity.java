...
public class DessertsIndividualItemActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.desserts_individual_item_page);
        ...
        btnLogo.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(DessertsIndividualItemActivity.this, MainActivity.class));
            }
        });
        ...
        btnMenu.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(DessertsIndividualItemActivity.this, MenuActivity.class));
            }
        });
        ...
        btnFeedback.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(DessertsIndividualItemActivity.this, FeedbackActivity.class));
            }
        });
        ...
        btnInformation.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(DessertsIndividualItemActivity.this, AboutUsActivity.class));
            }
        });
        ...
        btnCounter.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(DessertsIndividualItemActivity.this, CalculatorActivity.class));
            }
        });
        ...
        btnItemInfo.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(DessertsIndividualItemActivity.this, ItemInfoActivity.class));
            }
        });
