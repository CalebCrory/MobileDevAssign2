    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnLogo.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(DrinksActivity.this, MainActivity.class));
            }
        });
        ...
        btnFeedback.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(DrinksActivity.this, FeedbackActivity.class));
            }
        });
        ...
        btnInformation.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(DrinksActivity.this, AboutUsActivity.class));
            }
        });
        ...
        btnCounter.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(DrinksActivity.this, CalculatorActivity.class));
            }
        });
        ...
        btnItem1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(DrinksActivity.this, DrinksIndividualItemActivity.class));
            }
        });
