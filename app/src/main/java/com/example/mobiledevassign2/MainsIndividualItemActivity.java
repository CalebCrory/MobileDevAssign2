    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnAddItem.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                itemList.add("Main Item");
                calorieList.add(getString(R.string.txtMainsCalories));
                kcal += 400;
                GlobalLists.setKcal(kcal);

                AlertDialog alertDialog = new AlertDialog.Builder(MainsIndividualItemActivity.this).create();
