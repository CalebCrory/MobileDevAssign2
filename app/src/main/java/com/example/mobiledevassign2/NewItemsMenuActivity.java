...
public class NewItemsMenuActivity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        EdgeToEdge.enable(this);
        setContentView(R.layout.new_items_menu_page);
        ...
        btnLogo.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(NewItemsMenuActivity.this, MainActivity.class));
            }
        });
        ...
        btnMenu.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(NewItemsMenuActivity.this, MenuActivity.class));
            }
        });
        ...
        btnFeedback.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(NewItemsMenuActivity.this, FeedbackActivity.class));
            }
        });
        ...
        btnInformation.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(NewItemsMenuActivity.this, AboutUsActivity.class));
            }
        });
        ...
        btnCounter.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(NewItemsMenuActivity.this, CalculatorActivity.class));
            }
        });
        ...
        btnItem1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(NewItemsMenuActivity.this, NewIndividualItemActivity.class));
            }
        });
